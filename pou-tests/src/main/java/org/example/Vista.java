...
public class Vista {
    ...
    public void verMenuComida(Modelo pou) {
        ...
        if (pou.getHamburguesa() > 0) System.out.println("1. Hamburguesa (" + pou.getHamburguesa() + ")");
        if (pou.getKebab() > 0)       System.out.println("2. Kebab (" + pou.getKebab() + ")");
        if (pou.getTaco() > 0)        System.out.println("3. Taco (" + pou.getTaco() + ")");
        if (pou.getSushi() > 0)       System.out.println("4. Sushi (" + pou.getSushi() + ")");
        if (pou.getPan() > 0)         System.out.println("5. Pan (" + pou.getPan() + ")");
