    ...
    private void tienda() {
        ...
        if (op >= 1 && op <= 6) {
            if (modelo.getDinero() < precio) {
                ...
                switch (op) {
                    case 1: modelo.setHamburguesa(modelo.getHamburguesa() + 1); break;
                    case 2: modelo.setKebab(modelo.getKebab() + 1); break;
                    case 3: modelo.setTaco(modelo.getTaco() + 1); break;
                    case 4: modelo.setSushi(modelo.getSushi() + 1); break;
                    case 5: modelo.setPan(modelo.getPan() + 1); break;
                    case 6:
